...
export const CallBackPage: React.FC = () => {
    ...
    const { data: paymentData, isLoading: isPaymentDataLoading } = useRavePaymentCallbackQuery({ tx_ref: ref_id ?? "", tx_status: status ?? "false", transaction_id: transaction_id ?? 0 })
