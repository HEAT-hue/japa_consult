...
export const AdminRegisterPage: React.FC = () => {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        // Register user
        const response = await authRegister({ firstname: data.firstname, lastname: data.lastname, phone: data.phone, email: data.email, password: data.password, role: USERROLES.ADMIN });
